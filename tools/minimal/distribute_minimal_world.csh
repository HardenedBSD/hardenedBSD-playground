...
set _log="/tmp/${TARGET}-distrib-log-${_current_dir}-${_date}"
set _log_last="/tmp/${TARGET}-distrib-log-${_current_dir}.last"
...
(cd /usr/data/source/git/opBSD/${_current_dir}; make -j$__freebsd_mk_jobs -DNO_ROOT KERNCONF=OP-MINIMAL installkernel installworld distribution) |& tee -a ${_log}
